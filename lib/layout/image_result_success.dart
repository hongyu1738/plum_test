...
class ImageResultSuccess extends StatefulWidget {
  const ImageResultSuccess({ Key key }) : super(key: key);

  @override
  _ImageResultSuccessState createState() => _ImageResultSuccessState();
}

class _ImageResultSuccessState extends State<ImageResultSuccess> {
      ...
      body: Center(
        child: Column(
          children: [
            ...
            Text('Nice!', style: TextStyle(fontSize: 40, color: Colors.white)),
            ...
            BounceInDown(
              child: ElevatedButton(
                onPressed: () async { //Push replacement page of Image Quiz
                  await player.play('click_pop.mp3');
